...
/**
 * Created by Sofon on 27.05.2016.
 */
public class TPActivity extends ListActivity implements SwipeRefreshLayout.OnRefreshListener
{
    QuestTask Quest_T;
    TestTask Test_T;
    ...
    public void onBackPressed() {
        ...
        // super.onBackPressed();
        sqh.close();
        Intent intent = new Intent(TPActivity.this, MenuActivity.class);
        ...
        protected void onPostExecute(String result) {
            try {
                ...
                for (int j = 0; j < length - 1; j++) {
                    imagedownloadTask = new ImgDownloadTask(TPActivity.this);
    ...
    public void fillData() {
        DataBase sqh = new DataBase(TPActivity.this);
